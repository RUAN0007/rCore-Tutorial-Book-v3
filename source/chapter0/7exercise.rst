...
Difficulty of questions in after-school exercises and lab exercises:
...
1. `*` Install and configure the experimental environment in your operating system environment. Briefly describe the problem/difficulty you encountered and how it was resolved.
...
Note: Write in a Linux-like environment and try to debug application with debugging tools such as GDB, which can set breakpoints, execute single steps, and display variable information.
